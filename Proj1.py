...
def padding(plainText, key_length, hash_code_length=8):
    ...
    paddingLength = math.ceil((len(plainText) + hash_code_length) / key_length) * key_length - (
                len(plainText) + hash_code_length)
...
if __name__ == "__main__":
    ...
    plainTextList = ["Hi I'm Mangala Manmatharaja",
                     "I'm currently doing my degree program at SEUSL ",
                     "I'm a Network student",
                     "I have been assigned project 1",
                     "This project involves transposition cipher system with brute force attack"
                     ]
    ...
    print("Starting key search from length 1 to 9")
    ...
    print("Woooowhooh! Found key : ", final_key)
